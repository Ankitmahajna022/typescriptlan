...
const initialState: LibraryState = {
    ...
    issuedBooks: [],
    members: [
        { id: "m1", name: "Ankit", email: "ankit@gmail.com" }
    ]
}
...
const librarySlice = createSlice({
    ...
    reducers: {
        ...
        // this CRUD for  members

        addMembers(state, action: PayloadAction<Omit<Member, "id">>) {
            state.members.push({
                id: crypto.randomUUID(),
                ...action.payload
            })
        ...
        // is issue Book reducers ..
        issueBooks(state, action: PayloadAction<{ bookId: string, memberId: string }>) {
...
export const { addBook, updateBook, deleteBook, issueBooks, returnBook ,addMembers,updateMember,deleteMember} = librarySlice.actions
